...
const LoginPage = () => {
  ...
  const handleGoogleSignIn = () => {
    console.log("Google Sign In for Manager");
    navigate("/");
  };
  ...
  return (
    ...
    >
      ...
      <header className="header2">
        <div className="logo2">
          <img src="/mallify.png" alt="Mallify Logo" className="logo-image2" />
          <div className="logo-text-container">
            <span className="logo-name">Mallify</span>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group2">
                ...
                <input
                  ...
                  placeholder="manager@mallify.com"
                  required
                />
              </div>
